<template>
    <div class="flex items-start relative gap-5">
        <ToastList />
        <div :class="[sidebarOpen ? 'w-[290px] sm:shadow-none shadow-md' : 'sm:w-[64]', 'sm:fixed absolute delay-200 ease-in-out duration-500 whitespace-nowrap transform-all z-50 sm:bg-transparent bg-primary']">
