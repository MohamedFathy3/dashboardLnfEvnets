...
const {
    ...
    status,
    refresh,
} = await useApiFetch('/api/network/expire-soon-members', {
    method: 'POST',
    body: serverParams,
    lazy: true,
});
            ...
            <table class="table table-report font-light">
                <thead>
                    <tr class="uppercase text-sm">
                        <th>Name</th>
                        <th>Details</th>
                        <th class="whitespace-nowrap">Expire In</th>
                ...
                <tbody>
                    <template v-if="status !== 'pending' && rows">
                        <tr v-for="row in rows.data" :key="row.id">
                            ...
                            <td>
                                <div v-if="row.currentNetworkStatus" class="flex flex-col gap-1">
                                    <div class="flex flex-wrap items-center gap-1">
                                        ...
                                        <div class="font-medium flex items-center gap-1">
                                            <icon name="solar:hashtag-bold-duotone" class="size-4 opacity-50 shrink-0" />
