...
<template>
    <div v-if="company" class="flex flex-col gap-5">
        <div v-if="usePermissionCheck(['conference_member_list'])" class="flex flex-col gap-5">
            ...
            <div class="lg:flex lg:items-center lg:justify-between lg:gap-5">
                ...
                <div v-if="usePermissionCheck(['conference_member_update'])" class="lg:flex lg:items-center lg:gap-5 lg:space-y-0 space-y-5">
