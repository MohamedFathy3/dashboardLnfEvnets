                ...
                <tbody>
                    <template v-if="!pending && rows">
                        <tr v-for="row in rows.data" :key="row.id">
                            ...
                            <td>
                                <UiEventOrderStatusBadge :data="getLastOrderDetails(row.id)" />
                                <div class="mt-2 font-medium flex items-center gap-1">
                                    <icon name="solar:calendar-outline" class="size-4 shrink-0 opacity-50" />
                                    <span class="text-xs opacity-75">{{ row.eventRegisterDate }}</span>
                                </div>
                            </td>
                            <td class="text-right">
                                <div>
