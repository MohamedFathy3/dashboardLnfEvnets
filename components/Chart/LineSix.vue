<template>
    <div class="p-5 bg-white rounded-2xl h-full">
...
const data = ref<ChartData<'line'>>({
    ...
    datasets: [
        ...
        {
            label: props.chartDataValues[2]?.label,
            data: props.chartDataValues[2]?.data,
            backgroundColor: colors.white,
            tension: 0.4,
        ...
        {
            label: props.chartDataValues[3]?.label,
            data: props.chartDataValues[3]?.data,
            backgroundColor: colors.white,
            tension: 0.4,
            borderColor: colors.slate[400],
            pointBackgroundColor: colors.slate[400],
            borderWidth: 2,
        },
        {
            label: props.chartDataValues[4]?.label,
            data: props.chartDataValues[4]?.data,
            backgroundColor: colors.white,
            tension: 0.4,
