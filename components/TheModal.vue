            ...
            <headlessDialog as="div" class="relative z-[9999]" @close="closeModal">
                ...
                <div class="fixed inset-0 overflow-y-auto">
                    <div class="flex min-h-full items-center justify-center p-5 text-center">
                        ...
                        >
                            <HeadlessDialogPanel :class="['max-w-' + size]" as="form" class="w-full transform overflow-hidden rounded-2xl bg-white p-5 text-left align-middle shadow-xl transition-all dark:bg-slate-900">
